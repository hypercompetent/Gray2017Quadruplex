...
#output directory
outdir <- "new_isoform_plot/"

#gene sets
gene_set_file <- "../cuffdiff/isoform_set.txt"
...
#group definitions
groups <- list(gene_sets$group == "up",
               gene_sets$group == "nc",
               gene_sets$group == "dn")
group_colors <- c("orangered","black","dodgerblue")
group_names <- c("isoform_up","isoform_nc","isoform_dn")
...
#refseq filtering
filter_file <- "../geo/GSE60630_PDC3_vs_DMSO_isoform_exp.diff"
