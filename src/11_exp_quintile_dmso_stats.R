...
#output directory
outdir <- "exp_quintile_dmso_stats/"
...
#group definitions
groups <- list(gene_sets$value_1 >= quantiles[1] & gene_sets$value_1 <= quantiles[2],
               gene_sets$value_1 > quantiles[2] & gene_sets$value_1 <= quantiles[3],
               gene_sets$value_1 > quantiles[3] & gene_sets$value_1 <= quantiles[4],
               gene_sets$value_1 > quantiles[4] & gene_sets$value_1 <= quantiles[5],
               gene_sets$value_1 > quantiles[5] & gene_sets$value_1 <= quantiles[6])
...
dead_simple <- data.frame(group = rep(exp_groups,2),
                          ...
                          tss_250 = c(extract_results(g4_statistics, "ex1","dn",exp_groups,"nt"),
